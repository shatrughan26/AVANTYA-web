...
const AutoRAN = () => {
  return (
    /* PURE CARD LAYER ONLY: Sits perfectly into the parent grid track width constraints */
    <div className="group relative flex flex-col justify-between h-[240px] hover:h-[400px] w-full rounded-[2rem] border border-white/10 bg-slate-950/40 p-8 overflow-hidden cursor-pointer transition-all duration-700 ease-in-out hover:border-blue-500/40 hover:shadow-[0_0_50px_rgba(0,130,251,0.2)] backdrop-blur-md">
      
      {/* Background Masking Layers */}
      <div className="absolute inset-0 z-0 overflow-hidden rounded-[2rem]">
        <div className="w-full h-full transition-transform duration-700 ease-out group-hover:scale-105 bg-cover bg-center bg-blue-950/20" />
